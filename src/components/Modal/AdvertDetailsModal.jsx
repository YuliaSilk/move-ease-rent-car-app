...
import { AdvTitle, DescriptionContainer, AdvertImg, CLoseBtn, ModalWrapper, AdvSubDescr, IconClose, Description, AdvSubTitle, Btn, Condition, AdvSubDescrContainer, DescriptionList } from './AdvertDetailsModal.styled';
  ...
  return (
    <ModalWrapper className="custom-modal">
      ...
      <AdvSubDescrContainer>
        <AdvSubDescr>{city} | {country} | id: {id} | Year: {year} | Type: {type} | Fuel Consumption: {fuelConsumption} | Engine Size: {engineSize}</AdvSubDescr>
      </AdvSubDescrContainer>
